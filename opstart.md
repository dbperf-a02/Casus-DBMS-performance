...
## TODOs
- [x] Installeer de nodige software (zie verder)
- [x] Elk teamlid kloont deze repository
- [x] Vul de namen en contactinfo van de teamleden aan in het README-bestand
- [x] Wijzig de naam van "dbperf.tex" in [paper_nl/](paper_nl/) naar "dbperf-GGG.tex" (met GGG jullie groepnummer, bv g05 voor groep 5 op campus Gent)
- [x] Nog niet vertrouwd met het gebruik van Git? Kijk dan verder in dit document
